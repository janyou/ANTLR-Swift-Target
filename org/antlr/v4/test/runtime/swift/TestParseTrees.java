...
public class TestParseTrees extends BaseTest {
	...
	public void testAltNum() throws Exception {
		...
		StringBuilder grammarBuilder = new StringBuilder(575);
		grammarBuilder.append("grammar T;\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("options { contextSuperClass=MyRuleNode; }\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("@parser::members {\n");
		grammarBuilder.append("open class MyRuleNode: ParserRuleContext {\n");
		grammarBuilder.append("	public var altNum: Int = 0\n");
		grammarBuilder.append("    override\n");
		grammarBuilder.append("	public init(_ parent: ParserRuleContext?, _ invokingStateNumber: Int) {\n");
		grammarBuilder.append("        super.init(parent, invokingStateNumber)\n");
		grammarBuilder.append("    }\n");
		grammarBuilder.append("    override\n");
		grammarBuilder.append("	open func getAltNumber() -> Int { return altNum }\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("	override\n");
		grammarBuilder.append("	open func setAltNumber(_ altNum: Int) { self.altNum = altNum }\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("}\n");
		grammarBuilder.append("\n");
		grammarBuilder.append("\n");
