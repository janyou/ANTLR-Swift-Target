...
open class RLexer: Lexer {
    ...
    override
	open func getRuleNames() -> [String] { return RLexer.ruleNames }

	override
	open func getSerializedATN() -> String { return RLexer._serializedATN }

	override
	open func getModeNames() -> [String] { return RLexer.modeNames }

	override
	open func getATN() -> ATN { return RLexer._ATN }

    public static let _serializedATN: String = RLexerATN().jsonString
