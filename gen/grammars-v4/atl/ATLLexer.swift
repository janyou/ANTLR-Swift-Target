...
open class ATLLexer: Lexer {
	internal static var _decisionToDFA: [DFA] = {
          var decisionToDFA = [DFA]()
          let length = ATLLexer._ATN.getNumberOfDecisions()
          for i in 0..<length {
          	    decisionToDFA.append(DFA(ATLLexer._ATN.getDecisionState(i)!, i))
          }
	...
	public override init(_ input: CharStream) {
		...
		super.init(input)
		_interp = LexerATNSimulator(self, ATLLexer._ATN, ATLLexer._decisionToDFA, ATLLexer._sharedContextCache)
	}
    ...
    override
	open func getRuleNames() -> [String] { return ATLLexer.ruleNames }

	override
	open func getSerializedATN() -> String { return ATLLexer._serializedATN }

	override
	open func getModeNames() -> [String] { return ATLLexer.modeNames }

	override
	open func getATN() -> ATN { return ATLLexer._ATN }

    public static let _serializedATN: String = ATLLexerATN().jsonString
