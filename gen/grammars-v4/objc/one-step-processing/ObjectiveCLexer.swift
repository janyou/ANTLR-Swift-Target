// Generated from ./grammars-v4/objc/one-step-processing/ObjectiveCLexer.g4 by ANTLR 4.5.1
import Antlr4
...
open class ObjectiveCLexer: Lexer {
	...
	public static let AUTORELEASEPOOL=1, CATCH=2, CLASS=3, DYNAMIC=4, ENCODE=5, 
                   ...
                   COMMENT=154, LINE_COMMENT=155, BACKSLASH=156, SHARP=157, 
                   DIRECTIVE_IMPORT=158, DIRECTIVE_INCLUDE=159, DIRECTIVE_PRAGMA=160, 
                   DIRECTIVE_DEFINE=161, DIRECTIVE_DEFINED=162, DIRECTIVE_IF=163, 
                   DIRECTIVE_ELIF=164, DIRECTIVE_ELSE=165, DIRECTIVE_UNDEF=166, 
                   DIRECTIVE_IFDEF=167, DIRECTIVE_IFNDEF=168, DIRECTIVE_ENDIF=169, 
                   DIRECTIVE_TRUE=170, DIRECTIVE_FALSE=171, DIRECTIVE_ERROR=172, 
                   DIRECTIVE_WARNING=173, DIRECTIVE_BANG=174, DIRECTIVE_LP=175, 
                   DIRECTIVE_RP=176, DIRECTIVE_EQUAL=177, DIRECTIVE_NOTEQUAL=178, 
                   DIRECTIVE_AND=179, DIRECTIVE_OR=180, DIRECTIVE_LT=181, 
                   DIRECTIVE_GT=182, DIRECTIVE_LE=183, DIRECTIVE_GE=184, 
                   DIRECTIVE_WS=185, DIRECTIVE_STRING=186, DIRECTIVE_CONDITIONAL_SYMBOL=187, 
	   ...
	   public let COMMENTS_CHANNEL=2, DIRECTIVE_CHANNEL=3, IGNORED_MACROS=4
	public static let DIRECTIVE_MODE: Int = 1;
	public static let DEFINE: Int = 2;
	public static let DIRECTIVE_TEXT_MODE: Int = 3;
	...
	private static let _LITERAL_NAMES: [String?] = [
		...
		"'for'", "'id'", nil, "'in'", "'inout'", "'instancetype'", "'goto'", "'int'", 
		"'long'", "'oneway'", "'out'", "'register'", "'return'", "'short'", "'signed'", 
		"'sizeof'", "'static'", "'struct'", "'switch'", "'typedef'", "'union'", 
		"'unsigned'", "'void'", "'volatile'", "'while'", "'NS_OPTIONS'", "'NS_ENUM'", 
		"'__weak'", "'__unsafe_unretained'", "'__unused'", "'__deprecated'", "'__autoreleasing'", 
		"'typeof'", "'__typeof'", "'__typeof__'", "'__kindof'", "'__covariant'", 
		"'__contravariant'", "'__attribute__'", "'nullable'", "'nonnull'", nil, 
		nil, nil, nil, nil, "'__TVOS_PROHIBITED'", nil, nil, "'{'", "'}'", "'['", 
		"']'", "';'", "','", "'.'", "'->'", "'@'", "'='", nil, nil, nil, "'~'", 
		"'?'", "':'", nil, nil, nil, nil, nil, nil, "'++'", "'--'", "'+'", "'-'", 
		"'*'", "'/'", "'&'", "'|'", "'^'", "'%'", "'+='", "'-='", "'*='", "'/='", 
		"'&='", "'|='", "'^='", "'%='", "'<<='", "'>>='", "'...'", "'assign'", 
		"'getter'", "'nonatomic'", "'setter'", "'strong'", "'retain'", "'readonly'", 
		"'readwrite'", "'weak'", "'IBOutlet'", "'IBOutletCollection'", nil, nil, 
