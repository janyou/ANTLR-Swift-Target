// Generated from ./grammars-v4/objc/two-step-processing/ObjectiveCPreprocessorLexer.g4 by ANTLR 4.5.1
import Antlr4
...
open class ObjectiveCPreprocessorLexer: Lexer {
	...
	public static let SHARP=1, CODE=2, IMPORT=3, INCLUDE=4, PRAGMA=5, DEFINE=6, 
                   ...
                   SLASH=40
	   public let COMMENTS_CHANNEL=2
	public static let DIRECTIVE_MODE: Int = 1;
	public static let DIRECTIVE_DEFINE: Int = 2;
	public static let DIRECTIVE_TEXT: Int = 3;
